...
using Config = D3BEmu.Net.GS.Config;

namespace D3BEmu.Core.EmuNet.Games
{
    public class GameCreator : RPCObject
    {
        ...
        public void StartGame(List<EmuNetClient> clients, ulong objectId, D3.OnlineService.GameCreateParams gameCreateParams, string version)
        {
        ...
        public void JoinGame(List<EmuNetClient> clients, ulong objectId)
        {
        ...
        private bnet.protocol.game_master.ConnectInfo GetConnectionInfoForClient(EmuNetClient client)
        {
        ...
        private void SendConnectionInfo(EmuNetClient client)
        {
