...
namespace D3BEmu.Core.EmuNet.Objects
{
    ...
    public class RPCObject
    {
        ...
        /// </summary>
        public List<EmuNetClient> Subscribers { get; private set; }
        ...
        protected RPCObject()
        {
            ...
            this.Subscribers = new List<EmuNetClient>();
        }       
        ...
        public void AddSubscriber(EmuNetClient client, ulong remoteObjectId)
        {
        ...
        public void RemoveSubscriber(EmuNetClient client)
        {
        ...
        protected virtual void NotifySubscriptionAdded(EmuNetClient client) { }
