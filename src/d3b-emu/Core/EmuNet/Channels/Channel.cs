...
namespace D3BEmu.Core.EmuNet.Channels
{
    public class Channel : RPCObject
    {
        ...
        /// </summary>
        public readonly Dictionary<EmuNetClient, Member> Members = new Dictionary<EmuNetClient, Member>();

        /// <summary>
        /// Channel owner.
        /// </summary>
        public EmuNetClient Owner { get; private set; }
        ...
        public Channel(EmuNetClient client, ulong remoteObjectId)
        {
        ...
        public bool HasUser(EmuNetClient client)
        {
        ...
        public Member GetMember(EmuNetClient client)
        {
        ...
        public void SetOwner(EmuNetClient client)
        {
        ...
        public void Join(EmuNetClient client, ulong remoteObjectId)
        {
            client.MapLocalObjectID(this.DynamicId, remoteObjectId);
            this.AddMember(client);
        }

        public void AddMember(EmuNetClient client)
        {
            if (HasUser(client))
            {
        ...
        public void RemoveMember(EmuNetClient client, RemoveReason reason)
        {
            RemoveMember(client, reason, false);
        }

        public void RemoveMember(EmuNetClient client, RemoveReason reason, bool dissolving)
        {
        ...
        public void SendMessage(EmuNetClient client, bnet.protocol.channel.Message message)
        {
            var notification =
