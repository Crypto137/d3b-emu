...
namespace D3BEmu.Core.EmuNet.Accounts
{
    ...
    public class AccountCommands: CommandGroup
    {
        ...
        public string Add(string[] @params, EmuNetClient invokerClient)
        {
            if (@params.Count() < 2)
        ...
        public string Delete(string[] @params, EmuNetClient invokerClient)
        {
            if(@params.Count()==0)
        ...
        public string SetPassword(string[] @params, EmuNetClient invokerClient)
        {
            if (@params.Count() < 2)
        ...
        public string SetLevel(string[] @params, EmuNetClient invokerClient)
        {
            if (@params.Count() < 2)
    ...
    {
        [DefaultCommand]
        public string WhoAmI(string[] @params, EmuNetClient invokerClient)
        {
