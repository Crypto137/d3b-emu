...
namespace D3BEmu.Core.EmuNet.Commands
{
    public class CommandGroup
    {
        ...
        public virtual string Handle(string parameters, EmuNetClient invokerClient=null)
        {
        ...
        [DefaultCommand]
        public virtual string Fallback(string[] @params = null, EmuNetClient invokerClient = null)
        {
