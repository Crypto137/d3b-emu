...
namespace D3BEmu.Core.EmuNet.Friends
{
    public class FriendManager : RPCObject
    {
        ...
        public static void HandleInvitation(EmuNetClient client, bnet.protocol.invitation.Invitation invitation)
        {
        ...
        public static void HandleAccept(EmuNetClient client, bnet.protocol.invitation.GenericRequest request)
        {
        ...
        public static void HandleDecline(EmuNetClient client, bnet.protocol.invitation.GenericRequest request)
        {
            if (!OnGoingInvitations.ContainsKey(request.InvitationId)) return;
            var invitation = OnGoingInvitations[request.InvitationId];
        ...
        public static void HandleRemove(EmuNetClient client, bnet.protocol.friends.GenericFriendRequest request)
        {
