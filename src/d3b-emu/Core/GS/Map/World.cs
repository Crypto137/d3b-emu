...
using D3BEmu.Core.GS.Common.Types.QuadTrees;
...
namespace D3BEmu.Core.GS.Map
{
    public sealed class World : DynamicObject, IRevealable, IUpdateable
    {
        ...
        // Environment
        public D3BEmu.Common.MPQ.FileFormats.Environment Environment { get; private set; }
            ...
            : base(game.NewWorldID)
        {
            ...
            Environment = ((D3BEmu.Common.MPQ.FileFormats.World)D3BEmu.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.Worlds][snoId].Data).Environment;
        ...
        public bool CheckLocationForFlag(Vector3D location, D3BEmu.Common.MPQ.FileFormats.Scene.NavCellFlags flags)
        {
