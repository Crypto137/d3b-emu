...
using D3BEmu.Core.GS.Actors.Implementations.Minions;
...
namespace D3BEmu.Core.GS.Powers.Implementations
{
    ...
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.HungeringArrow)]
    ...
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.EntanglingShot)]
    ...
    #region EvasiveFire
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.EvasiveFire)]
    ...
    #region FanOfKnives
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.FanOfKnives)]
    ...
    //Complete
    #region BolaShot
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.BolaShot)]
    ...
    //Complete
    #region Grenades
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.Grenades)]
    ...
    #region Chakram
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.Chakram)]
    ...
    // wip very rough implementation
    #region Impale
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.Impale)]
    public class Impale : Skill
    {
        public override IEnumerable<TickTimer> Main()
        {
            ...
            if (Target != null)
            {
                Target.PlayEffectGroup(RuneSelect(213968, 213977, 213981, 213982, 213983, 214042));    // TODO: find correct impact effects for each rune
            }            
    ...
    #region SpikeTrap
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.SpikeTrap)]
    ...
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.ElementalArrow)]
    ...
    #region Multishot
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.Multishot)]
    ...
    #region ClusterArrow
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.ClusterArrow)]
    ...
    //No runes yet.
    #region RapidFire
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.RapidFire)]
    ...
    // 9359 implementation + crash fixes
    //TODO: possibly redo, this is a concept.
    #region Strafe
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.Strafe)]
    public class Strafe : ChanneledSkill
    {
        ...
        public override IEnumerable<TickTimer> Main()
        {
            ...
            if (Target != null)
            {
                ...
                proj1.OnCollision = (hit) =>
                {
                    // impact effect doesn't work in 7447
    ...
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Offense.RainOfVengeance)]
    ...
    public class ShadowPower : Skill
    {
        ...
        class ShadowPowerFemale : PowerBuff
        {
            ...
            public override bool Apply()
            {
                ...
                if (Rune_E > 0)
                {
                    //Target.Attributes[GameAttribute.Damage_Percent_Reduction_Turns_Into_Heal] += ScriptFormula(5);    // attribute missing in 7447
                }
    ...
    //Complete
    #region Preparation
    [ImplementsPowerSNO(Skills.Skills.DemonHunter.Utility.Preparation)]
