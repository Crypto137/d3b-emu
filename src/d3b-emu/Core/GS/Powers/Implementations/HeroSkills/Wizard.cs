...
namespace D3BEmu.Core.GS.Powers.Implementations
{
    ...
    // Old visual only 7447 Implementation (9359 implementation is "broken")
    #region Shock Pulse
    [ImplementsPowerSNO(Skills.Skills.Wizard.RapidCast.ShockPulse)]
    ...
    [ImplementsPowerSNO(Skills.Skills.Wizard.RapidCast.SpectralBlade)]
    ...
    #region Electrocute
    [ImplementsPowerSNO(Skills.Skills.Wizard.RapidCast.Electrocute)]
    ...
    public class DiamondSkin : Skill
    {
        ...
        class DiamondSkinBuff : PowerBuff
        {
            ...
            public override bool Apply()
            {
                if (!base.Apply())
                    return false;
                User.Attributes[D3BEmu.Net.GS.Message.GameAttribute.Look_Override] = 0x061F7489;
            ...
            {
                base.Remove();
                User.Attributes[D3BEmu.Net.GS.Message.GameAttribute.Look_Override] = 0;
    ...
    public class WizardTeleport : PowerScript
    {
        public override IEnumerable<TickTimer> Run()
        {
            if (!User.World.CheckLocationForFlag(TargetPosition, D3BEmu.Common.MPQ.FileFormats.Scene.NavCellFlags.AllowWalk))
            {
    ...
    // diiis skill override implementation (without individual skill implementations yet)
    #region Archon
