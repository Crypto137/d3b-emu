...
namespace D3BEmu.Core.GS.Powers.Implementations
{
    ...
    // 9359 Implementation + cleave area damage fix
    //Complete:Check
    #region Cleave
    ...
    #region SeismicSlam
    [ImplementsPowerSNO(Skills.Skills.Barbarian.FurySpenders.SeismicSlam)]
    ...
    // 9359 implementation + replace Damage_Percent_Reduction_From_Melee and Damage_Percent_Reduction_From_Ranged with Damage_Reduction_Current
    ...
    public class IgnorePain : Skill
    {
        ...
        public class IgnorePainBuff : PowerBuff
        {
            ...
            public override bool Apply()
            {
                if (!base.Apply())
                    return false;
                User.Attributes[GameAttribute.Damage_Reduction_Current] += Convert.ToInt32(ScriptFormula(10));
                Target.Attributes.BroadcastChangedIfRevealed();
                if (Rune_D > 0)
                {
                    AttackPayload attack = new AttackPayload(this);
        ...
        public class ObsidianAlliesBuff : PowerBuff
        {
            ...
            public override bool Apply()
            {
                ...
                Target.Attributes[GameAttribute.Damage_Reduction_Current] -= Convert.ToInt32(ScriptFormula(10));
                Target.Attributes.BroadcastChangedIfRevealed();
