    ...
    public class DeathPayload : Payload
    {
        ...
        public void Apply()
        {
            ...
            */
            ...
            // wtf is this?
            this.Target.World.BroadcastIfRevealed(new D3BEmu.Net.GS.Message.Definitions.Effect.PlayEffectMessage()
            {
                ActorId = this.Target.DynamicID,
                Effect = D3BEmu.Net.GS.Message.Definitions.Effect.Effect.Unknown12,
            }, this.Target);
            ...
            if (LootAndExp)
            {
                if (this.Context.User is Player)
                {
                    ...
                    if (D3BEmu.Common.Helpers.Math.RandomHelper.Next(1, 100) < 20)
