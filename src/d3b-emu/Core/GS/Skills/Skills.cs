    ...
    public class Skills
    {
        ...
        public static List<int> GetPrimarySkillsByClass(ToonClass @class)
        {
            switch (@class)
            {
                ...
                case ToonClass.DemonHunter:
                    return DemonHunter.Offense.List;
                case ToonClass.Monk:
                    return Monk.SpiritGenerators.List;
                case ToonClass.WitchDoctor:
                    return WitchDoctor.PhysicalRealm.List;
                case ToonClass.Wizard:
                    return Wizard.RapidCast.List;
                default:
                    return null;
            }
        }
        ...
        public class Barbarian
        {
            ...
            public class FurySpenders
            {
                ...
                public const int SeismicSlam = 0x000153CD;
        ...
        {
            public static readonly List<int> AllActiveSkillsList =
                Offense.List.Concat(Discipline.List).Concat(Utility.List).ToList();
        ...
        {
            public static readonly List<int> AllActiveSkillsList =
                SpiritGenerators.List.Concat(SpiritSpenders.List).Concat(Mantras.List).ToList();

            public class SpiritGenerators
            {
        ...
        {
            public static readonly List<int> AllActiveSkillsList =
                RapidCast.List.Concat(Offensive.List).Concat(Utility.List).ToList();

            public class RapidCast
            {
