...
namespace D3BEmu.Core.GS.Actors
{
    public abstract class Actor : WorldObject
    {
        ...
        /// </summary>
        private D3BEmu.Common.MPQ.FileFormats.QuestRange _questRange;

        protected D3BEmu.Common.MPQ.FileFormats.ConversationList ConversationList;
        ...
        public D3BEmu.Common.MPQ.FileFormats.Actor ActorData { get; private set; }

        /// <summary>
        /// The animation set for actor.
        /// </summary>
        public D3BEmu.Common.MPQ.FileFormats.AnimSet AnimationSet { get; private set; }
            ...
            : base(world, world.NewActorID)
        {
            ...
            this.ActorData = (D3BEmu.Common.MPQ.FileFormats.Actor)D3BEmu.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.Actor][snoId].Data;
            if (this.ActorData.AnimSetSNO != -1)
                this.AnimationSet = (D3BEmu.Common.MPQ.FileFormats.AnimSet)D3BEmu.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.AnimSet][this.ActorData.AnimSetSNO].Data;
        ...
        public virtual void OnTargeted(Player player, D3BEmu.Net.GS.Message.Definitions.World.TargetMessage message)
        {
        ...
        protected virtual void ReadTags()
        {
            ...
            if (Tags.ContainsKey(MarkerKeys.QuestRange))
            {
                ...
                if (D3BEmu.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.QuestRange].ContainsKey(snoQuestRange))
                    _questRange = D3BEmu.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.QuestRange][snoQuestRange].Data as D3BEmu.Common.MPQ.FileFormats.QuestRange;
            ...
            if (Tags.ContainsKey(MarkerKeys.ConversationList))
            {
                ...
                if (D3BEmu.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.ConversationList].ContainsKey(snoConversationList))
                    ConversationList = D3BEmu.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.ConversationList][snoConversationList].Data as D3BEmu.Common.MPQ.FileFormats.ConversationList;
        ...
        public void Move(Vector3D point, float facingAngle)
        {
            ...
            if (this.AnimationSet == null)
                aniTag = -1;
            else if (this.AnimationSet.TagExists(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Walk))
                aniTag = this.AnimationSet.GetAnimationTag(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Walk);
            else if (this.AnimationSet.TagExists(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Run))
                aniTag = this.AnimationSet.GetAnimationTag(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Run);
            else
                aniTag = -1;
