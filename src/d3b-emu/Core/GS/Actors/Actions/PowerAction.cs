                ...
                else
                {
                    ...
                    if (_pathUpdateTimer == null || _pathUpdateTimer.TimedOut)
                    {
                        ...
                        if (this.Owner.AnimationSet == null)
                            aniTag = -1;
                        else if (this.Owner.AnimationSet.TagExists(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Walk))
                            aniTag = this.Owner.AnimationSet.GetAnimationTag(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Walk);
                        else if (this.Owner.AnimationSet.TagExists(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Run))
                            aniTag = this.Owner.AnimationSet.GetAnimationTag(D3BEmu.Common.MPQ.FileFormats.AnimationTags.Run);
                        else
                            aniTag = -1;
