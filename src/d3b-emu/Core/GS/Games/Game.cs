...
using D3BEmu.Core.GS.Generators;
...
namespace D3BEmu.Core.GS.Games
{
    public class Game : IMessageConsumer
    {
        ...
        public Game(int gameId)
        {
            ...
            loopThread.Start();
            Pathfinder = new D3BEmu.Core.GS.AI.Pather(this); //Creates the "Game"s single Pathfinder thread, Probably could be pushed further up and have a single thread handling all path req's for all running games. - DarkLotus
