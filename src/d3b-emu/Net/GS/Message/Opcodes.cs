...
namespace D3BEmu.Net.GS.Message
{
    public enum Opcodes : int
    {
        ...
        GameSetupMessageAck = 48, // len: 	8   former SimpleMessage7
        NewPlayerMessage = 49, // len: 	16916
        PlayerBannerMessage = 50, // len: 	    former GenericBlobMessage6
        ...
        CancelChanneledSkillMessage = 84, // len: 	12  former DWordDataMessage3
        ...
        ACDTranslateNormalMessage = 110, // len: 	76  former NotifyActorMovementMessage
        ACDTranslateSnappedMessage = 111, // len: 	36
        ACDTranslateFacingMessage = 112, // len: 	20
        ...
        PlayerTranslateFacingMessage = 121, // len: 	20  former ACDTranslateFacingMessage2
        ...
        QuestStepCompleteMessage = 150, // len: 	former GenericBlobMessage7
        ...
        PetDetachMessage = 156, // len: 	12  former ANNDataMessage20
        ...
        ShrineActivatedMessage = 174, // len: 	12  former ANNDataMessage22
        ...
        HeartbeatMessage = 185, // len: 	8   former SimpleMessage11
        PlayConvLineMessage = 186, // len: 	168
        StopConvLineMessage = 187, // len: 	16
        AdvanceConvMessage = 188, // len: 	12  former IntDataMessage3
        ...
        PlayLoreWithButton = 212, // len: 	16 // former LoreMessage1 LoreMessage in 9359
        ...
        BlacksmithDataProgressMessage = 234, // len: 	    former GenericBlobMessage8
        JewelerDataProgressMessage = 235, // len: 	    former GenericBlobMessage9
        MysticDataProgressMessage = 236, // len: 	former GenericBlobMessage10
        BlacksmithDataInitialMessage = 237, // len: 	former GenericBlobMessage11
        JewelerDataInitialMessage = 238, // len: 	former GenericBlobMessage12
        MysticDataInitialMessage = 239, // len: 	former GenericBlobMessage13
        ...
        RequestTrainArtisanMessage = 267, // len: 	8   former SimpleMessage33
        ...
        LoadCompleteMessage = 293, // len: 	8   former SimpleMessage41
        NPCInteractCancel = 294, // len: 	8   former SimpleMessage42
        NPCSelectConversationMessage = 295, // len: 	12 former SNODataMessage6
        HirelingDismissMessage = 296, // len: 	12 former ANNDataMessage33
        CraftInteractionMessage = 297, // len: 	8   former SimpleMessage43
