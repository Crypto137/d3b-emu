...
namespace D3BEmu.Net.GS.Message
{
    ...
    public class ScriptedAttributeInitializer
    {
        ...
        public static void ProcessAttributes(GameAttribute[] attributes)
        {
            ...
            string sourcePathBase = Path.Combine(Path.GetTempPath(), "D3BEmuScriptedAttributeFuncs");

            using (StreamWriter fout = new StreamWriter(sourcePathBase + ".cs"))
            {
                fout.Write(
@"// This file was auto-generated by d3b-emu class ScriptedAttributeInitializer
...
namespace D3BEmu.Net.GS.Message.GeneratedCode
{
...
");
            ...
            Type funcs = results.CompiledAssembly.GetType("D3BEmu.Net.GS.Message.GeneratedCode.ScriptedAttributeFuncs");
