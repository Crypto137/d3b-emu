...
namespace D3BEmu.Common.MPQ.FileFormats
{
    ...
    public class HeroTable : ISerializableData
    {
        ...
        public void Read(MpqFileStream stream)
        {
            ...
            this.PrimaryResourceMax = stream.ReadValueF32(); //352
            this.PrimaryResourceFactorLevel = stream.ReadValueF32(); //356
            this.PrimaryResourceRegenPerSecond = stream.ReadValueF32(); //360
            stream.Position += 4;
            this.SecondaryResourceMax = stream.ReadValueF32(); //368
            this.SecondaryResourceFactorLevel = stream.ReadValueF32(); //372
            this.SecondaryResourceRegenPerSecond = stream.ReadValueF32(); //376
            stream.Position += 24;
